...
func TestCanDeseraliseRequiredUInt64DeltaOperatorEncodedValueNoPreviousValue(t *testing.T) {
	...
	unitUnderTest := NewDeltaOperation(properties.New(1, "UInt64Field", true, testLog))
...
func TestCanDeseraliseRequiredUInt64DeltaOperatorWithInitialValueEncodedValueNoPreviousValue(t *testing.T) {
	...
	unitUnderTest := NewDeltaOperationWithInitialValue(properties.New(1, "UInt64Field", true, testLog), 7)
...
func TestCanDeseraliseRequiredUInt64DeltaOperatorEncodedPositiveDeltaValuePreviousValue(t *testing.T) {
	...
	// Act
	dict.SetValue("UInt64Field", fix.NewRawValue(uint64(2)))
	result, err := unitUnderTest.Deserialise(messageAsBytes, &pmap, &dict)
	if err != nil {
		t.Errorf("Got an error when none was expected: %s", err)
	}
...
func TestCanDeseraliseRequiredUInt64DeltaOperatorEncodedNegativeDeltaValuePreviousValue(t *testing.T) {
	...
	// Act
	dict.SetValue("UInt64Field", fix.NewRawValue(uint64(529)))
	result, err := unitUnderTest.Deserialise(messageAsBytes, &pmap, &dict)
	if err != nil {
		t.Errorf("Got an error when none was expected: %s", err)
	}
...
func TestCanDeseraliseRequiredUInt64DeltaOperatorEncodedMaxPositiveUInt64ToZero(t *testing.T) {
	...
	// Act
	dict.SetValue("UInt64Field", fix.NewRawValue(uint64(math.MaxUint64)))
	result, err := unitUnderTest.Deserialise(messageAsBytes, &pmap, &dict)
	if err != nil {
		t.Errorf("Got an error when none was expected: %s", err)
	}
...
func TestCanDeseraliseRequiredUInt64DeltaOperatorEncodedZeroToMaxPositiveUInt64(t *testing.T) {
	...
	unitUnderTest := NewDeltaOperationWithInitialValue(properties.New(1, "UIn64Field", true, testLog), 7)

	// Act
	dict.SetValue("UIn64Field", fix.NewRawValue(uint64(0)))
	result, err := unitUnderTest.Deserialise(messageAsBytes, &pmap, &dict)
	if err != nil {
		t.Errorf("Got an error when none was expected: %s", err)
	}
...
func TestCanDeseraliseRequiredUInt64DeltaOperatorEncodedNegativeDeltaValueOverflowsUInt64Error(t *testing.T) {
	...
	// Act
	dict.SetValue("UInt64Field", fix.NewRawValue(uint64(0)))
	_, err := unitUnderTest.Deserialise(messageAsBytes, &pmap, &dict)
...
//	<delta />
//</uint64>
func TestCanDeseraliseOptionalUInt64DeltaOperatorEncodedPreviousNullValueReturnsBaseValue(t *testing.T) {
	// Arrange pmap = 10000000 1 = 10000011
	messageAsBytes := bytes.NewBuffer([]byte{130})
	pmap, _ := presencemap.New(bytes.NewBuffer([]byte{128}))
	dict := dictionary.New()
	expectedMessage := uint64(1)
	unitUnderTest := NewDeltaOperation(properties.New(1, "UInt64Field", false, testLog))
...
func TestCanDeseraliseOptionalUInt64DeltaOperatorNotEncodedReturnsNull(t *testing.T) {
	...
	// Act
	dict.SetValue("UInt64Field", fix.NewRawValue(uint64(27)))
	result, err := unitUnderTest.Deserialise(messageAsBytes, &pmap, &dict)
	if err != nil {
		t.Errorf("Got an error when none was expected: %s", err)
	}
