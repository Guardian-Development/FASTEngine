...
//	<delta />
//</int64>
func TestCanDeseraliseRequiredInt64DeltaOperatorEncodedPreviousNullValueReturnsError(t *testing.T) {
...
//	<delta/>
//</int64>
func TestCanDeseraliseRequiredInt64DeltaOperatorNotEncodedReturnsNull(t *testing.T) {
